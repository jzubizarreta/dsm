...
if __name__ == "__main__":
    ...
    for sequence in sequences:
        ...
        for run_number in range(args.runs_per_sequence):
            print("Running DSM on sequence %s run number %d" %
            ...
            subprocess.run(["%s/../../build/bin/EurocExample" % dir_path,
                            ...
                            "%s/calib0_%s.txt" % (dir_path,
                                                  args.resolution.split("_")[0]),
                            "%s/settings.txt" % dir_path,
                            "autorun"],
                           cwd=dir_path)
            ...
            if not failed:
                ...
                evaluate_ate_scale_proc = subprocess.Popen(["python2", "-u",
                                                            "%s/../../Evaluation/evaluate_ate_scale.py" % dir_path,
                                                            gt_file_name,
